# Code of Conduct
Pollianna welcomes developers from all walks of life,
with different backgrounds, and with a wide range of experience.

To give clarity of what is expected of our members, Pollianna has adopted the code of conduct
defined by [contributor-covenant.org](https://www.contributor-covenant.org). This document is used across many open source
communities. The full text is copied below:
...
contacting a project maintainer at [pollianna-conduct@group.apple.com](mailto:pollianna-conduct@group.apple.com).
...
This policy is adapted from the [Contributor Code of Conduct](https://www.contributor-covenant.org/version/1/3/0/code-of-conduct/).

## Reporting

A working group of community members is committed to promptly addressing any
[reported issues](mailto:pollianna-conduct@group.apple.com).
